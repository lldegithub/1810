require(["config"],function(){
    require(["jq","loginbar","data","totop","jt","pinpai"],function(a,b,c){
        // 封装cookie的设置、获取、删除
        var Cookie = {
        ...
        $cartBtn.on("click",function(e){
            e.stopPropagation();
            let guid = $(this).parent("li").attr("guid");
            gouwuche(guid);
            gwcRendar(cartArr);
            tcRendar();
        });
        ...
        $shopping.on("mouseover",function() {
            ...
            if (cartArr.length == 0) {
                ...
                $shopping_content.css("display","block");
                $gwclist.css("display","block");
            }else{
                $shopping_btn.css("display", "none");
                $shopping_btn2.css("display","block");
                $shopping_content.css("display","none");
                $gwclist.css("display","block");
            }
